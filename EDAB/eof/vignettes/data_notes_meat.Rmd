---
title: "EOF data processing meat weight"
...
land <- readRDS(here::here("EDAB/eof/comlandEOFMeatAggGear.rds"))$comland |> 
...
ofd <- readRDS(here::here("EDAB/eof/otherfish_discards_meat_EOF.rds"))
ofd |>
  dplyr::filter(EPU %in% c("GOM", "GB", "MAB")) |>
  dplyr::group_by(YEAR, EPU) |>
...
byEPU <- readRDS(here::here("EDAB/eof/total_landings_discards_meat_by_EPU.rds")) 
...
discards <- readRDS(here::here("EDAB/eof/true_discards_meat_EOF.rds")) 
discards |>
  dplyr::filter(EPU %in% c("GOM", "GB", "MAB")) |>
