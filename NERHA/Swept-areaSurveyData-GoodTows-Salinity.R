...
#Albatross and Delaware data 1963-2008, all seasons:
qry <- c(
  ...
  towdur, setdepth, surftemp, bottemp, surfsalin, botsalin, 
...
dateOfPull <- format(Sys.time(), "%m-%d-%y")
saveRDS(survey,file = here::here(out.dir,paste0("NEFSC_2009-2024survey_data_sweptarea",dateOfPull,".rds")))
